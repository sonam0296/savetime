...
import { editCenterData, editUserData } from '../../redux/actions/actions';
...
const UsersTableContent = () => {
    ...
    const handleOnSearch = async (e) => {
        ...
        const response = await instance.post(`${requests.fetchList}?search=${e.target.value}&limit=20&pageNo=1`, body, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
                ...
                >
                  {column.label}
                            ...
                            <TableRow style={{ border: '2px solid #D50032' }}>
                                ...
                                <TableCell
                                    style={{ border: '2px solid #D50032', width: '100px' }}
                                >
                                    Name
                                </TableCell>
                                <TableCell
                        ...
                        <TableBody>
                            {data && data.map((item, index) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell style={{ border: '2px solid #D50032', width: '2200px' }}>
                                        {item.emailAddress}
                                    </TableCell>
