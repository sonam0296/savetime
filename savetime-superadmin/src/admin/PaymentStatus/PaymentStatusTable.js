...
import { HouseOutlined, CreditCardRounded } from '@material-ui/icons';
...
import { editCenterData, editPaymentData } from '../../redux/actions/actions';
...
const PaymentStatusesTableContent = () => {
    ...
    const onEdit = (e, item) => {
        dispatch(editPaymentData(item));
        history.push('/admin/updatePayment')
    }
...
export default connect(mapStateToProps)(PaymentStatusesTableContent)