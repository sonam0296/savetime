...
import { editWorkerData } from '../../redux/actions/actions';
...
const WorkersTableContent = () => {
    ...
    const getWorkerList = async () => {
        ...
        const response = await instance.get(`${requests.fetchWorkerList}?limit=20&pageNo=1`, bodyAPI, {
            headers: {
    ...
    const handleOnSearch = async (e) => {
        ...
        const response = await instance.get(`${requests.fetchWorkerList}?search=${e.target.value}&limit=20&pageNo=1`, {}, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    const onEdit = (e, item) => {
        dispatch(editWorkerData(item));
        history.push('/admin/workerUpdate')
    }
                ...
                >
                  {column.label}
                            ...
                            <TableRow style={{ border: '2px solid #D50032' }}>
                                ...
                                <TableCell
                                    style={{ border: '2px solid #D50032', width: '150px' }}
                                >
                                    Name
                                </TableCell>
                                <TableCell
                        ...
                        <TableBody>
                            {data && data.map((item, index) => (
                                <TableRow key={item.id}>
                                    ...
                                    <TableCell style={{ border: '2px solid #D50032', width: '150px', textAlign: 'center' }} >
                                        {item.name}
                                    </TableCell>
                                    ...
                                    <TableCell style={{ border: '2px solid #D50032', width: '100px', textAlign: 'center' }} >
                                        <EditRoundedIcon
...
export default connect(mapStateToProps)(WorkersTableContent)