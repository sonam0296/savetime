...
const CenterDatabase = () => {
 ...
 const history= useHistory()
  ...
  const [clientsProps, setClientsProps] = useState([]);
  ...
  const getClients = async () => {
    ...
    if (response && response.data) {
      ...
      res.map((clients) => {
        ...
        clientsDataOption.push(clientData);
      });
      const clientOption = {
        options: clientsDataOption,
        getOptionLabel: (option) => option.title,
      };
      setClientsProps(clientOption);
    }
  };
  ...
  const getWorkers = async () => {
    const response = await instance
      .get(`${requests.fetchGetWorkersForAdmin}${loginData._id}?lang=${language}`, {
        headers: {
          Authorization: `Bearer ${logincenterToken}`,
        },
      })
  ...
  const getAppomentId = async () => {
    ...
    if (response && response.data) {
      console.log("response appoinment ",response)
  ...
  const getTableData = async (body) => {
    ...
    const response = await instance
      .post(`${requests.fetchGetAppointment}?lang=${language}`, apiBody, {
        headers: {
          Authorization: logincenterToken,
        },
      })
  ...
  const applyFilter = async (e) => {
    ...
    if (selectedCustomer != "") {
      body.clientName = selectedCustomer;
    }
    getTableData(body);
  };
          ...
          >
            ...
            <Grid container item sm={3} xl={3} lg={3} xs={3} col>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label={t("Services")} margin="normal" />
                )}
              />
            </Grid>
            ...
            <Grid container item sm={3} xl={3} lg={3} xs={3} col>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label={t("Customer")} margin="normal" />
                )}
              />
            </Grid>
          </Grid>
          ...
          >
            <Grid container item sm={3} xl={3} lg={3} xs={3} col>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Id" margin="normal" />
                )}
              />
            </Grid>
            <Grid container item sm={3} xl={3} lg={3} xs={3} col>
